...
- v1.2.0 (2026-08-05): 栽培単位の目印(mark)、タグ自由追加+記録からの学習表示、詳細画面のタグ絞り込み
- v1.3.0 (2026-08-05): 栽培環境フィールド(container/nutrient/aeration/training)、
  計測メトリクス追加(brix/taste 1-5/tempC/waterC)。液肥切替は作業タグ「液肥切替」で履歴を残す運用
